...
#include "TEIncrementPathIndex.h"
...
UTEIncrementPathIndex::UTEIncrementPathIndex()
{

}

EBTNodeResult::Type UTEIncrementPathIndex::ExecuteTask(UBehaviorTreeComponent& OwnerComp, uint8* NodeMemory)
{
